...
public class SoftAssert1 {
	...
	public void verifyValidLogin() {
		...
		softAssert2.assertEquals("actualUserName", "Admin");
		softAssert2.assertNotEquals(actualUserName, "Admi");
		...
		softAssert.assertFalse(str.contains("str"));
		softAssert.assertTrue(driver.getCurrentUrl().contains("login"));
		softAssert.assertFalse(driver.getCurrentUrl().contains("abcd"));

		 System.out.println(" This is after all assertioons ");
		
		 softAssert.assertAll();                        //softassert;softassert
	}
